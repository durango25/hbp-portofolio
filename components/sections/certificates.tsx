                ...
                >
                  ...
                  <CardHeader className="">
                    <div className="flex items-center gap-2">
                      <Badge
                        className={`${typeColors[cert.type] || ""}`}
                      >
                        {cert.type}
                      </Badge>
                    </div>
        ...
        {activeCert && lightboxIndex !== null && (
          ...
          >
            ...
            <motion.div
              ...
              className="relative w-full h-full max-w-4xl max-h-[80vh] flex items-center justify-center pointer-events-none sm:pointer-events-auto"
            >
              <Image
            ...
            <motion.div
              ...
              className="absolute bottom-6 right-6 text-white text-right"
            >
              <Badge className={`mb-1 text-xs ${typeColors[activeCert.type] || ""}`}>
                {activeCert.type}
              </Badge>
              <div className="text-xs text-white/70">
                {activeCert.date}{activeCert.expiry && ` · Exp: ${activeCert.expiry}`}
              </div>
              <h4 className="text-xs font-semibold leading-snug text-white">{activeCert.name}</h4>
              <p className="text-xs text-white/60 md:text-sm">{activeCert.issuer}</p>
              {activeCert.link && (
                <a
